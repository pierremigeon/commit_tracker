df <- read.table(file='./commit_tracker_project/commit_tracker::master.data', header=TRUE)

#create png
png("./commit_tracker_project/commit_tracker_lineplot.png", width=700, height=480)
par(mar = c(7, 7, 6, 5))
